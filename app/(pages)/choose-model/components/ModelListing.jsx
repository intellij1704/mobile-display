...
// Brand Listing Page with custom red scrollbars and series filtering
...
function ModelsNotFound({ categoryName }) {
    return (
        <div className="min-h-[60vh] flex items-center justify-center px-4 py-8">
            <div className="text-center max-w-md mx-auto">
                ...
                <h1 className="text-2xl font-bold mb-2">Models Not Found</h1>
                <p className="text-gray-600 mb-6">
                    Sorry, we couldn't find any models for {categoryName}.
                </p>
                <Link
                    href="/"
...
export default function BrandListing() {
    ...
    if (seriesError || modelsError)
        return <p className="text-center text-red-500 py-20">Failed to load data</p>

    if (!series || series.length === 0)
        return <ModelsNotFound categoryName={categoryName} />
