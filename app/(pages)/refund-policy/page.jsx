    ...
    return (
        <section className="bg-white text-black">
            <div className="max-w-8xl mx-auto px-4 sm:px-6 md:px-12 lg:px-20 py-12">
                ...
                <p className="mb-2">
                    Replacement requests are accepted only in the following cases:
                </p>
                <ul className="list-disc pl-6 space-y-1">
                ...
                <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>
                        Clear, uncut, and unedited videos (no pauses) of the product unboxing
                        and packaging must be shared for verification.
                    </li>
                    <li>
                        Upon successful verification, replacement or re-dispatch will be
                        initiated within 7 working days.
                    </li>
                </ul>
                ...
                <p className="leading-relaxed">
                    Orders cannot be cancelled once placed. Cancellation or refunds are not
                    permitted before or after dispatch. Non-acceptance of shipment from
                    the courier delivery personnel does not qualify for a refund.
                </p>
                ...
                <p className="mb-2">
                    Approved refunds are processed within 7 working days from: Any approved refund will be processed exclusively through the UPI payment method, regardless of the original payment mode.
                </p>
                <ul className="list-disc pl-6 space-y-1">
                    <li>Confirmation of non-dispatch, or</li>
                    <li>
                        Receipt of the returned product at our warehouse (if applicable).
                    </li>
                </ul>
                <p className="mt-3">
                Refunds are issued to the original payment method (UPI, card, net banking) or other approved modes.
                ...
                <p className="mb-2">
                    Customers will be informed via email or phone regarding:
                </p>
                <ul className="list-disc pl-6 space-y-1">
