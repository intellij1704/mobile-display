  ...
  return (
    <section className="bg-white text-black">
        ...
        <p className="mb-4 leading-relaxed">
          ...
          . We are committed to delivering your orders safely, quickly, and
          transparently. Please review our Shipping Policy below to understand
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>
            Shipped via reputed courier partners such as Ecom Express
          </li>
          <li>
        ...
        <p className="font-semibold mt-4">Express Shipping (Air)</p>
        <ul className="list-disc pl-6 space-y-1">
          <li>
            Eligible products (excluding batteries and restricted items) may be
            shipped via air courier services
          </li>
          <li>
            Up to 90% of express shipments are delivered within 72 hours,
        ...
        <p className="mb-2">
          After dispatch, customers will receive a confirmation email or
          message containing:
        </p>
        <ul className="list-disc pl-6 space-y-1">
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>
            Orders cannot be cancelled once they have been picked up by the
            courier partner.
          </li>
          <li>
            No refunds will be provided for cancellation requests made after
            dispatch.
          </li>
        </ul>
        ...
        <p className="mb-2">
          If we are unable to dispatch your order within 5 working days, you
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>Payment for out-of-stock items will be refunded</li>
        </ul>

        <p className="mt-3">
          The applicable option will be communicated to you for confirmation.
        </p>
        ...
        <p className="mb-2">
          ...
          Our responsibility is limited until the shipment is handed over to
          the courier partner.
        </p>
        ...
        <p className="mt-3">
          However, we will assist customers in coordinating with courier
