...
export default function CheckoutPage() {
  ...
  // Trigger confetti when success state becomes true
  useEffect(() => {
    if (success) {
      confetti({
        particleCount: 150,
  ...
  return (
    <main className="flex flex-col min-h-screen bg-gray-50">
      ...
      <section className="flex-1 flex flex-col min-h-[70vh] md:min-h-[100vh] justify-center items-center px-4 py-16">
