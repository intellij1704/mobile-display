...
async function CheckoutProcessor({ searchParams }) {
  ...
  try {
    ...
    return (
      <section className="min-h-screen flex flex-col gap-6 justify-center items-center text-center px-4 py-8 md:px-8 lg:px-16">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href={"/orders"} className="w-full sm:w-auto text-white bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-lg font-semibold transition-colors">
            View My Orders
          </Link>
          <Link href={"/product"} className="w-full sm:w-auto text-blue-600 border border-blue-600 px-6 py-3 rounded-lg bg-white hover:bg-gray-50 transition-colors">
            Continue Shopping
          </Link>
        </div>
      </section>
    ...
    return (
      <section className="min-h-screen flex flex-col gap-6 justify-center items-center text-center px-4 py-8 md:px-8 lg:px-16">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href={"/cart"} className="w-full sm:w-auto text-white bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-lg font-semibold transition-colors">
            Back to Cart
          </Link>
        </div>
      </section>
