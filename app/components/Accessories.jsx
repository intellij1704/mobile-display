...
export default function Accessories() {
  ...
  const accessoriesCategories = categoriesList.filter((c) =>
    ["Mic", "Ear Speaker", "Tools", "Sim Socket"].includes(c.name)
  );
    ...
    <section className="w-full bg-[#FFFFF] py-12 px-4 sm:px-6 lg:px-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex md:items-center md:flex-row flex-col gap-4 justify-between mb-8 px-2">
          ...
          <Link
            href={"/categories"}
            className="md:text-2xl text-lg text-[#005EB7] hover:text-blue-800 font-medium transition-all duration-200 hover:underline flex md:justify-center justify-end md:items-center gap-3"
          >
            See All
            <img
